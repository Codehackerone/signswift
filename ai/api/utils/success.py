...
class SuccessMessage:
  ...
  def __init__(self, message: str = "Success", status_code: int = 200, data: Optional[Dict[str, Any]] = None, **kwargs: Any):
    """
...
if __name__ == "__main__":
  try:
    success = SuccessMessage("Success", 200, details="Additional details.", more_info="https://example.com")
